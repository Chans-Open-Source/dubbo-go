...
func (g *dubboGrpc) GenerateImports(file *generator.FileDescriptor) {
	g.P("import (")
	g.P(`dgrpc "github.com/chans-open-source/dubbo-go/protocol/grpc"`)
	g.P(`"github.com/chans-open-source/dubbo-go/protocol/invocation"`)
	g.P(`"github.com/chans-open-source/dubbo-go/protocol"`)
	g.P(` ) `)
}
