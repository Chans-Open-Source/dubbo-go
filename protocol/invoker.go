...
//go:generate mockgen -source invoker.go -destination mock/mock_invoker.go  -self_package github.com/chans-open-source/dubbo-go/protocol/mock --package mock  Invoker
// Extension - Invoker
